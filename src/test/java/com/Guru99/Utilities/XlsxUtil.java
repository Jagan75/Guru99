...
public class XlsxUtil {
	...
	public XlsxUtil(String xlspath) {
	...
	public HashMap<String,String> getTestData(String sheetName, String testCaseName)  {
		int rownum=0;
		...
		try{
			...
			for(int i=1;i<=rowCount;i++){
				if(testCaseName.equalsIgnoreCase(getCellData(sheetName,1,i))){
					rownum=i;
			...
			for (int j = 1; j < colCount; j++) {
				excelData.put(getCellData(sheetName,j,1),getCellData(sheetName,j,rownum));
			}
		}catch (Exception e){
			e.printStackTrace();
		}
